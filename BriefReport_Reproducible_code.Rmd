---
title: "Reproducible code for 'Chemolithoautotrophic bacteria flourish at dark water-ice interfaces of an emerged Arctic cold seep'"
...
```{r Save taxonomy barplots, eval = FALSE, include = FALSE}
ggsave("~/Desktop/Figure1C.pdf", plot.winter.abund.cdna + theme(legend.position = "none"), width = 3.5, height = 4)
```
